...
* **🎙️ Live Voice Transcription (Whisper AI):** Real-time local voice dictation directly into your prompt area. Powered by Whisper AI with intelligent Voice Activity Detection (VAD) that naturally filters out idle noise and clips silent spaces to prevent hallucinations.
* **🔊 Audio Device Persistent Config:** Dynamically switch between multiple microphones or input devices via a quick right-click context menu synchronized across both audio buttons. Your choice is automatically remembered for the next startup.
* **👁️ Vision Support:** Upload and analyze images (.jpg, .png) (e.g., with llava) in Generate mode.
* **🎵 Audio Support:** Upload and analyze audio files (.wav, .mp3) (e.g., with gemma4) in Generate mode.
...
* **🛠️ Tools & Functions:** Local Python code execution by the model.
...
* **🎤 Audio Record:** Process audio records through a Vision LLM with audio support (gemma4).
...
> **Whisper Model:** For the Live Voice Transcription feature, place your preferred multiligual GGML model file (e.g., `ggml-base.bin` or `ggml-tiny.bin`) directly into the application build/startup folder.
...
### 1. System Prompt
Define the "personality" of the AI (e.g., "You are an experienced developer"). Check the **Use System Prompt** box to send this instruction before every chat.
...
Ollama Desktop utilizes several open-source third-party libraries and components to expand its capability suite:

* **Ollama_Desktop:** [MIT License](https://opensource.org/licenses/MIT)
* **Newtonsoft.Json:** [MIT License](https://opensource.org/licenses/MIT)
* **Scintilla5.NET:** [MIT License](https://opensource.org/licenses/MIT)
* **SSH.NET:** [MIT License](https://opensource.org/licenses/MIT)
* **Whisper.net & Whisper.net.Runtime:** [MIT License](https://github.com/sandrohanea/whisper.net/blob/main/LICENSE) (Wrapper around ggerganov's whisper.cpp).
* **NAudio:** [MIT License](https://github.com/naudio/NAudio/blob/master/license.txt) (Audio playback and recording capabilities).
...
* **PdfPig:** [Apache License 2.0](http://www.apache.org/licenses/LICENSE-2.0).
* **Siticone.NetCore.UI:** Proprietary UI Component License.
...
Hier ist die Aufschlüsselung der Komponenten, einzeln aufgelistet für deine Dokumentation oder den Lizenzbereich in der `README.md`:
